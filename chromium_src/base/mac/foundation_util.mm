...
//
//  #if defined(OFFICIAL_BUILD)
//    return "com.dissenter.Browser";
//  #else
//    return "com.dissenter.Browser.development";
//  #endif
//
...
const char* BaseBundleID() {
  ...
  switch (chrome::GetChannel()) {
    case version_info::Channel::CANARY:
      return "com.dissenter.Browser.nightly";
    case version_info::Channel::DEV:
      return "com.dissenter.Browser.dev";
    case version_info::Channel::BETA:
      return "com.dissenter.Browser.beta";
